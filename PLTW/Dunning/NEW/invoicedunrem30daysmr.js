   ...
   function (record, runtime, email, file, render, nsutil, search) {
      ...
      function getInputData() {
         ...
         try {
            ...
            var st30DaysSavedSearchId = runtime.getCurrentScript().getParameter('custscript_invoicereminder30_ss');
      ...
      function reduce(context) {
         ...
         try {
            ...
            var stSender = runtime.getCurrentScript().getParameter('custscript_email_sender_30d');
            var stEmailTemplate = runtime.getCurrentScript().getParameter('custscript_email_template_30d');
            var stInvoiceTemplatePDFId = runtime.getCurrentScript().getParameter('custscript_inv_pdf_id_30d');
            var st30DaysMainFolder = runtime.getCurrentScript().getParameter('custscript_pdffolder_30d');
      ...
      function getCreateFolder(stMainFolder, stFolderName) {
         ...
         try {
            ...
            var stSavedSearchPastDueFolders = runtime.getCurrentScript().getParameter('custscript_folders_30d');
