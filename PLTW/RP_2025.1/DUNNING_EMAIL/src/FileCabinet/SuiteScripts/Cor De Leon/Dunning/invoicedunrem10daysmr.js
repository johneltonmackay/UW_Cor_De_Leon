   ...
   (record, runtime, email, file, render, nsutil, search) => {
      ...
      const getInputData = () => {
         ...
         try {
            ...
            let today = new Date();
            const mainFolder = runtime.getCurrentScript().getParameter('custscript_pdffolder');
            ...
            const invoiceSearchId = runtime.getCurrentScript().getParameter('custscript_invoicereminder_ss');
      ...
      const reduce = (context) => {
         ...
         try {
            ...
            let invoices = [];
            let receivers = [];
            const sender = runtime.getCurrentScript().getParameter('custscript_email_sender');
            const emailTemplate = runtime.getCurrentScript().getParameter('custscript_email_template');
            const invoiceTemplatePDFId = runtime.getCurrentScript().getParameter('custscript_inv_pdf_id');
      ...
      const createFolder = (mainFolder, today) => {
         ...
         try {
            ...
            const reminderFolders = runtime.getCurrentScript().getParameter('custscript_folders');
