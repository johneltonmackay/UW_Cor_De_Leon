        ...
        const getInputData = (inputContext) => {
            ...
            try {
                let objTransactionSearch = search.create({
                    type: 'revenueplan',
                    filters: [
                        ['revenueelement.elementdate', 'within', '2024-01-01', '2024-01-31'],
                        'AND',
                        ['plannedperiod', 'anyof', '58', '59', '60', '56', '55'],
                        'AND',
                        ['amount', 'notequalto', '0.00'],
                        'AND',
                        ['revenuerecognitionrule', 'anyof', '12', '2', '1'],
                        // 'AND',
                        // ['internalid', 'anyof', '3378651', '3378356', '3378652'],
                        // ['internalid', 'anyof', '3378650'],
                        // ['internalid', 'anyof', '3378650', '3378651', '3378356', '3378652'],
                      ],
                    columns: [
